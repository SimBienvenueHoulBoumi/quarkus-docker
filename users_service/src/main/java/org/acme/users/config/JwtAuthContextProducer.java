...
/**
 * Produce a JWT configuration that explicitly supplies the shared secret to the MP-JWT layer.
 * Without this, the runtime keeps looking for a key location and rejects every Bearer token.
 */
@ApplicationScoped
@Alternative
