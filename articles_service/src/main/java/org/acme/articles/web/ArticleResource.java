...
import org.acme.articles.service.ArticleService;
import org.acme.articles.web.dto.ArticleRequest;
import org.acme.articles.web.dto.ArticleResponse;
import org.acme.articles.web.dto.StockUpdateRequest;
...
public class ArticleResource {
    ...
    public List<ArticleResponse> getAvailableArticles() {
        return articleService.findAvailable();
    }
    ...
    public ArticleResponse updateStock(@PathParam("id") Long id, @Valid StockUpdateRequest request) {
        return articleService.updateStock(id, request.getStock());
    }
